            ...
            <div className="hidden sm:flex items-center gap-2">
                <button
                  ...
                  style={{
                    ...
                    color: '#0F5E7B',
                    boxShadow: '0 4px 6px -1px rgba(255, 211, 80, 0.3), 0 2px 4px -1px rgba(255, 211, 80, 0.2)'
                  }}
                >
                  All Onboardings
                </button>
              ...
              <button
                ...
                style={{
                  boxShadow: '0 4px 6px -1px rgba(15, 94, 123, 0.3), 0 2px 4px -1px rgba(15, 94, 123, 0.2)'
                }}
              >
            ...
            <div className="sm:hidden relative">
              ...
              <div
                ...
                style={{
                  ...
                  boxShadow: '-4px 0 6px -1px rgba(255, 211, 80, 0.3), -2px 0 4px -1px rgba(15, 94, 123, 0.2)'
                }}
              >
                {/* Menu Header with Close Button */}
                <div className="flex items-center justify-between p-4 border-b bg-gradient-to-r from-cyan-50 to-yellow-50" style={{ borderColor: '#FFD350' }}>
                ...
                <div className="py-2 bg-white">
                  ...
                  <div className="my-2 mx-2" style={{ borderTop: '1px solid #FFD350', opacity: 0.5 }} />
                  <button
                    onClick={async () => {
                      setMenuOpen(false)
                      await handleLogout()
