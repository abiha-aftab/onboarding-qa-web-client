  ...
  return (
    <div className="bg-white rounded-xl shadow-lg overflow-hidden">
      <div className="bg-gradient-to-r from-green-50 to-cyan-50 px-4 sm:px-6 py-6 sm:py-8 text-center">
        ...
        <p className="text-sm sm:text-base md:text-lg mb-4 sm:mb-6 px-2" style={{ color: '#576472' }}>
        ...
        {submittedValues && (
          <div className="mt-6 sm:mt-8 space-y-3 sm:space-y-4 max-w-2xl mx-auto px-2 sm:px-0">
            {steps.map((step) => {
              ...
              return (
                <div key={step.id} className="bg-white rounded-lg p-3 sm:p-4 shadow-sm border-2 border-[#FFD350]">
