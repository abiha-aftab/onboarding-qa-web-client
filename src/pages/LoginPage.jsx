      ...
      <div className="w-full flex items-center justify-center py-4 sm:py-8 px-4">
        <div className="w-full max-w-[400px] mx-auto space-y-4 sm:space-y-6">
          <div className="text-center mb-4 sm:mb-6">
            <img src={logo} alt="Limitless Horizons Logo" className="h-16 sm:h-20 mx-auto mb-2 sm:mb-3 w-auto max-w-[180px] sm:max-w-[220px]" />
          </div>

          <div className="bg-white rounded-xl shadow-2xl p-6 sm:p-10 w-full">
            <h1 className="text-lg sm:text-xl md:text-2xl font-bold mb-3 sm:mb-4 text-center break-words" style={{ color: '#0F5E7B' }}>
              Welcome back
            </h1>

            <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-5 mt-4 sm:mt-6">
              <div>
                <label htmlFor="email" className="block text-sm sm:text-base font-semibold mb-2 sm:mb-3 tracking-tight" style={{ color: '#0F5E7B' }}>
                  Email Address
                </label>
                <input
                  id="email"
              ...
              <div>
                <label htmlFor="password" className="block text-sm sm:text-base font-semibold mb-2 sm:mb-3 tracking-tight" style={{ color: '#0F5E7B' }}>
                  Password
                </label>
                <input
                  id="password"
            ...
            <div className="mt-5 sm:mt-7 text-center">
              <a href="#" className="link-secondary text-xs sm:text-sm font-semibold hover:underline">
